function openManageTicketsModal(cinemaId) {
    fetch(`https://localhost:7042/TicketApi/GetMoviesByCinema/${cinemaId}`,
        {
            method: 'GET',
            credentials: 'include'
        })
...
function updateAvailableTickets(movieId, cinemaId) {
    ...
    fetch('https://localhost:7042/TicketApi/UpdateAvailableTickets', {
        method: 'POST',
        credentials: 'include',
...
function buyTicketsModal(cinemaId, movieId) {
    fetch(`https://localhost:7042/TicketApi/GetAvailableTickets`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                CinemaId: cinemaId,
